# objdump
# Autogenerated from man page /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/share/man/man1/objdump.1
...
complete -c objdump -l no-leading-addr -d 'When disassembling, do not print leading addresses'
complete -c objdump -l no-print-imm-hex -d 'Do not use hex format for immediate values in disassembly output (default)'
...
complete -c objdump -l print-imm-hex -d 'Use hex format when printing immediate values in disassembly output'
...
complete -c objdump -s d -l disassemble -d 'Disassemble all text sections found in the input files'
