# irb
# Autogenerated from man page /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/share/man/man1/irb.1
...
complete -c irb -l readline -d 'Uses Readline extension module.  Pp'
complete -c irb -l noreadline -d 'Doesn\'t use Readline extension module.  Pp'
...
complete -c irb -l back-trace-limit -d 'Displays backtrace top n and tail n Ns.  The default value is 16.  Pp'
complete -c irb -l irb_debug -d 'Sets internal debug level to n (not for popular use) Pp El Pp ENVIRONMENT -ta…'
