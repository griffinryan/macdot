# ssh-add
# Autogenerated from man page /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX.sdk/usr/share/man/man1/ssh-add.1
...
complete -c ssh-add -l apple-use-keychain -d 'When adding identities, each passphrase will also be stored in the user\'s key…'
complete -c ssh-add -l apple-load-keychain -d 'Add identities to the agent using any passphrase stored in the user\'s keychain'
