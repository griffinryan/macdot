# git-branch
# Autogenerated from man page /Applications/Xcode.app/Contents/Developer/usr/share/man/man1/git-branch.1
...
complete -c git-branch -s u -l set-upstream-to -d 'Set up <branchname>\\(aqs tracking information so <upstream> is considered <br…'
